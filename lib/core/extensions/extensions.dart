...
extension DateTimeExtension on DateTime {
  ...
  String formattedDateLong() {
    return '$monthName $day, $year';
  }

  /// Format date as yyyy-MM-dd
  String formattedDateIso() {
...
extension AlignExtension on Widget {
  ...
  Widget getHorizontalPadding({required double padding}) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: sizes!.widthRatio * padding),
      child: this,
    );
  }
  ...
  Widget getIPadHorizontalPadding() {
    return Padding(
      padding: EdgeInsets.symmetric(
        horizontal: sizes!.isPhone
            ? sizes!.widthRatio * 16.0
            : sizes!.widthRatio * 32.0,
      ),
      child: this,
    );
  }
  ...
  Widget get6VerticalPadding() {
    return Padding(
      padding: EdgeInsets.symmetric(vertical: sizes!.heightRatio * 6.0),
      child: this,
    );
  }
  ...
  Widget get6HorizontalPadding() {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: sizes!.widthRatio * 6.0),
      child: this,
    );
  }
