...
class BankDetailResponse {
  ...
  BankDetailResponse({this.status, this.code, this.message, this.payload});
...
class Payload {
  ...
  Payload({this.bank, this.supportDetails});

  factory Payload.fromJson(Map<String, dynamic> json) {
    return Payload(
      bank: json['bank'] != null ? Bank.fromJson(json['bank']) : null,
      supportDetails: json['supportDetails'] != null
          ? List<SupportDetails>.from(
              json['supportDetails'].map((x) => SupportDetails.fromJson(x)),
            )
          : [],
    );
  }
  ...
  Map<String, dynamic> toJson() => {
        'bank': bank?.toJson(),
        'supportDetails':
            supportDetails?.map((e) => e.toJson()).toList(),
      };
}
...
class Bank {
  String? id;
  MultiLang? bankName;
  MultiLang? accountName;
  String? accountNumber;
  MultiLang? accountType;
  MultiLang? currency;
  String? iban;
  String? logoUrl;
  String? swiftCode;
  ...
  factory Bank.fromJson(Map<String, dynamic> json) {
    return Bank(
      id: json['_id'],
      bankName: MultiLang.fromJson(json['bankName']),
      accountName: MultiLang.fromJson(json['accountName']),
      accountNumber: json['accountNumber'],
      accountType: MultiLang.fromJson(json['accountType']),
      currency: MultiLang.fromJson(json['currency']),
      iban: json['iban'],
...
class MultiLang {
  ...
  factory MultiLang.fromJson(dynamic json) {
    ...
    return MultiLang(en: json?.toString(), ar: json?.toString());
  }
