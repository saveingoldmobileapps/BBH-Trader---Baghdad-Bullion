...
class DirectTransferbankResponse {
  ...
  String? _message;
  Payload? _payload;
  DirectTransferbankResponse copyWith({
    String? status,
    num? code,
    String? message,
    Payload? payload,
