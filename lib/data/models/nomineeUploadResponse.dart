...
uploadNomineeResponse uploadNomineeResponseFromJson(String str) =>
    uploadNomineeResponse.fromJson(json.decode(str));
String uploadNomineeResponseToJson(uploadNomineeResponse data) =>
    json.encode(data.toJson());

class uploadNomineeResponse {
  uploadNomineeResponse({
    String? status,
    num? code,
    String? message,
    Payload? payload,
  ...
  uploadNomineeResponse.fromJson(dynamic json) {
    _status = json['status'];
    _code = json['code'];
  ...
  String? _message;
  Payload? _payload;
  uploadNomineeResponse copyWith({
    String? status,
    num? code,
    String? message,
    Payload? payload,
...
class Payload {
  ...
  Payload.fromJson(dynamic json) {
    _residencyProofURL = json['nomineeDocument'];
  }
  String? _residencyProofURL;
  Payload copyWith({
    String? residencyProofURL,
  }) => Payload(
    residencyProofURL: residencyProofURL ?? _residencyProofURL,
  );
  String? get residencyProofURL => _residencyProofURL;

  Map<String, dynamic> toJson() {
    final map = <String, dynamic>{};
    map['nomineeDocument'] = _residencyProofURL;
    return map;
  }
}
