...
class _KycFormData {
  ...
  String? gender;
  final TextEditingController nationality = TextEditingController(text: 'Iraqi');
  final TextEditingController dob = TextEditingController();
  final TextEditingController countryBirth = TextEditingController(text: 'Iraq');
  ...
  bool _validate(int step) {
    switch (step) {
      ...
      case 10:
        ...
        if (_form.fatca == 'Yes') {
          if (!_nonEmpty(_form.fatcaTin.text) || !_nonEmpty(_form.fatcaAddr.text)) {
          ...
          children: [
                      ...
                      children: [
                        ...
                        const Column(
                          ...
                          children: [
                            ...
                            Text(
                              'BNK-001 · v1.0',
                              style: TextStyle(fontSize: 11, color: _KycPalette.inkSoft),
                            ),
                          ],
                        ),
                        const Spacer(),
            ...
            Padding(
              ...
              child: ElevatedButton(
                ...
                child: Text(
                  _currentPage == _totalSteps - 1 ? 'COMPLETE' : 'CONTINUE',
                  style: const TextStyle(
          ...
          child: RichText(
            text: TextSpan(
              ...
              children: [
                TextSpan(
                  text: bold,
                  style: const TextStyle(fontWeight: FontWeight.w700, color: _KycPalette.ink),
                ),
                TextSpan(text: ' $body'),
              ],
            ),
      ...
      child: Column(
        ...
        children: [
          ...
          _clause(
            ...
            'Two items are captured digitally — the Client\'s live profile photograph and the chip-read data from the national ID card. Both are linked by the KYC Reference.',
          ),
          const SizedBox(height: 28),
          InkWell(
            onTap: () => setState(() => _form.purposeConfirmed = !_form.purposeConfirmed),
            borderRadius: BorderRadius.circular(12),
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(12),
                border: Border.all(
                  color: _form.purposeConfirmed ? _KycPalette.ink : const Color(0xFFE0D6C4),
              ...
              child: Row(
                ...
                children: [
                  AnimatedContainer(
                    ...
                    height: 22,
                    decoration: BoxDecoration(
                      color: _form.purposeConfirmed ? _KycPalette.ink : Colors.white,
                      borderRadius: BorderRadius.circular(6),
                      border: Border.all(color: _KycPalette.ink),
                    ),
                    child: _form.purposeConfirmed
                        ? const Icon(Icons.check, size: 16, color: _KycPalette.cream)
                        : null,
                  ),
                  const SizedBox(width: 12),
                  const Expanded(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(child: _textField(c: _form.arFirst, label: 'الاسم الأول')),
                const SizedBox(width: 12),
                Expanded(child: _textField(c: _form.arFather, label: 'اسم الأب')),
              ],
            ),
            const SizedBox(height: 16),
            Row(
              children: [
                Expanded(child: _textField(c: _form.arGf, label: 'اسم الجد')),
                const SizedBox(width: 12),
                Expanded(child: _textField(c: _form.arSurname, label: 'اللقب')),
              ],
            ),
            const SizedBox(height: 16),
            _textField(c: _form.arMother, label: 'اسم الأم'),
          ],
        ),
      ),
    );
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(child: _textField(c: _form.enFirst, label: 'First Name', cap: TextCapitalization.words)),
              const SizedBox(width: 12),
              Expanded(child: _textField(c: _form.enFather, label: "Father's Name", cap: TextCapitalization.words)),
            ],
          ),
          const SizedBox(height: 16),
          Row(
            children: [
              Expanded(child: _textField(c: _form.enGf, label: "Grandfather's", cap: TextCapitalization.words)),
              const SizedBox(width: 12),
              Expanded(child: _textField(c: _form.enSurname, label: 'Surname', cap: TextCapitalization.words)),
            ],
          ),
        ],
      ),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 20),
          _textField(c: _form.nationality, label: 'Nationality', cap: TextCapitalization.words),
          const SizedBox(height: 16),
          Row(
            children: [
              Expanded(
                child: _textField(
                  ...
                  label: 'Date of Birth',
                  readOnly: true,
                  onTap: () => _pickDate(_form.dob),
                ),
              ),
              const SizedBox(width: 12),
              Expanded(child: _textField(c: _form.countryBirth, label: 'Country of Birth', cap: TextCapitalization.words)),
            ],
          ),
          const SizedBox(height: 16),
          _textField(
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _textField(c: _form.idIssuePlace, label: 'Place of Issue'),
          const SizedBox(height: 16),
          Row(
            children: [
              Expanded(
                child: _textField(
                  ...
                  label: 'Date of Issue',
                  readOnly: true,
                  onTap: () => _pickDate(_form.idIssueDate),
                ),
              ),
              const SizedBox(width: 12),
              Expanded(
                child: _textField(
                  ...
                  readOnly: true,
                  onTap: () => _pickDate(_form.idExpiryDate),
                ),
              ),
            ],
          ),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _rule(),
          const SizedBox(height: 12),
          _lede('If the Client does not hold a residence card, mark this section "N/A".'),
          const SizedBox(height: 20),
          if (_form.residenceNa)
            Padding(
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: const Text(
                        ...
                        style: TextStyle(color: _KycPalette.inkSoft, fontWeight: FontWeight.w600),
                      ),
                    ),
                  ),
                  TextButton(
          ...
          IgnorePointer(
            ...
            child: Opacity(
              ...
              child: Column(
                children: [
                  _textField(c: _form.resNo, label: 'Residence Card Number'),
                  const SizedBox(height: 16),
                  _textField(c: _form.resPlace, label: 'Place of Issue'),
                  const SizedBox(height: 16),
                  Row(
                    children: [
                      Expanded(
                        child: _textField(
                          ...
                          label: 'Date of Issue',
                          readOnly: true,
                          onTap: () => _pickDate(_form.resIssue),
                        ),
                      ),
                      const SizedBox(width: 12),
                      Expanded(
                        child: _textField(
                          ...
                          label: 'Date of Expiry',
                          readOnly: true,
                          onTap: () => _pickDate(_form.resExpiry),
                        ),
                      ),
                    ],
                  ),
            ...
            child: Opacity(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 16),
                  _textField(c: _form.ppPlace, label: 'Place of Issue'),
                  const SizedBox(height: 16),
                  Row(
                    children: [
                      Expanded(
                      ...
                      Expanded(
                        child: _textField(
                          ...
                          label: 'Date of Expiry',
                          readOnly: true,
                          onTap: () => _pickDate(_form.ppExpiry),
                        ),
                      ),
                    ],
                  ),
        ...
        children: [
          ...
          DropdownButtonFormField<String>(
            ...
            items: [
              ...
              ..._educationLevels.map((e) => DropdownMenuItem(value: e, child: Text(e))),
            ],
          ...
          DropdownButtonFormField<String>(
            ...
            items: [
              const DropdownMenuItem(value: null, child: Text('Select…')),
              ..._sectors.map((e) => DropdownMenuItem(value: e, child: Text(e))),
            ],
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(child: _textField(c: _form.addrGov, label: 'Governorate')),
              const SizedBox(width: 12),
              Expanded(child: _textField(c: _form.addrDistrict, label: 'District')),
            ],
          ),
          const SizedBox(height: 16),
          Row(
            children: [
              Expanded(child: _textField(c: _form.addrCity, label: 'City / Town')),
              const SizedBox(width: 12),
              Expanded(child: _textField(c: _form.addrMahalla, label: 'Mahalla')),
            ],
          ),
          const SizedBox(height: 16),
          Row(
            children: [
              Expanded(child: _textField(c: _form.addrStreet, label: 'Street')),
              const SizedBox(width: 12),
              Expanded(child: _textField(c: _form.addrHouse, label: 'House No.')),
            ],
          ),
          const SizedBox(height: 16),
          _textField(
          ...
          const SizedBox(height: 16),
          _textField(c: _form.addrLandmarkEn, label: 'Nearest Landmark (English)'),
        ],
      ),
    );
  }
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          if (_form.pep == 'Yes') ...[
            const SizedBox(height: 20),
            _textField(c: _form.pepPosition, label: 'Position Held / Relationship to PEP'),
            const SizedBox(height: 16),
            _textField(c: _form.pepCountry, label: 'Country', cap: TextCapitalization.words),
            const SizedBox(height: 16),
            Row(
              children: [
                Expanded(
