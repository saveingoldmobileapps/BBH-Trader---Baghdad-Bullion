...
class ForgotPhoneVerifyCodeScreen extends ConsumerStatefulWidget {
  ...
  const ForgotPhoneVerifyCodeScreen({
    super.key,
    required this.phoneNumber,
  });

  @override
  ConsumerState createState() => _ForgotPhoneVerifyCodeScreenState();
}

class _ForgotPhoneVerifyCodeScreenState
    extends ConsumerState<ForgotPhoneVerifyCodeScreen> {
                    ...
                    onTap: () async {
                      ...
                      if (_formKey.currentState?.validate() ?? false) {
                        ...
                        await authStateReadProvider
                            .verifyPhoneVerifyPasscodeForgotPassword(
                              phoneNumber: widget.phoneNumber,
