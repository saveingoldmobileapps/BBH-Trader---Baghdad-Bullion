...
class PhoneVerifyCodeScreen extends ConsumerStatefulWidget {
  final String phoneNumber;
  final bool? isFirstTime;
  final bool? isDemo;
  const PhoneVerifyCodeScreen({
    super.key,
...
class _VerifyCodeScreenState extends ConsumerState<PhoneVerifyCodeScreen> {
                  ...
                  getVerifyButton(
                    ...
                    onTap: () async {
                      ...
                      if (_formKey.currentState?.validate() ?? false) {
                        ...
                        await authStateReadProvider.userPhoneVerifyPasscode(
                          phoneNumber: widget.phoneNumber,
                          passcode: pinController.text.toString().trim(),
                          isFirstTime: widget.isFirstTime ?? false,
