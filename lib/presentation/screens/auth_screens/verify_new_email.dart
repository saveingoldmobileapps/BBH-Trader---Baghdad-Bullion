...
class VerifyNewEmailScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState createState() => _VerifyNewEmailScreenState();
}
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref
          ...
          .resendOtpPreVerifyEmail(email: widget.email, context: context);
    });
                      ...
                      children: [
                        ...
                        OtpTimerButton(
                          ...
                          onPressed: () async {
                            ...
                            await authStateReadProvider.resendOtpPreVerifyEmail(
                              email: widget.email,
                              context: context,
                            );
                          },
                ...
                getVerifyButton(
                  ...
                  onTap: () async {
                    if (_formKey.currentState?.validate() ?? false) {
                      ...
                      final receivedOtp =
                          authStateWatchProvider.oneTimePassword;
                      ...
                      if (enteredOtp == receivedOtp) {
                        ...
                        await genericPopUpWidget(
                          ...
                          subtitle: AppLocalizations.of(
                            context,
                          )!.email_update_des, //"You Will be logged out after email updates successfully",//"OTP Verified Successfully!",
                          ...
                          onYesPress: () async {
                            await authStateReadProvider.updateUserEmail(
                              context: context,
                        ...
                        /// You can now call your email update API if needed
                        // await authStateReadProvider.verifyUserEmailAndUpdate(
                        //   email: widget.email,
                        //   passcode: enteredOtp,
                        //   context: context,
                        // );
                        ...
                        Toasts.getErrorToast(
                          ...
                          text: AppLocalizations.of(
                            context,
                          )!.entered_wrong_otp, //"Entered PIN is not correct",
                        );
                      }
                    }
                  },
