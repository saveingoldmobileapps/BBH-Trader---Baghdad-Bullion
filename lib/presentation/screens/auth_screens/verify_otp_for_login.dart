...
class LoginPhoneVerifyCodeScreen extends ConsumerStatefulWidget {
  final String phoneNumber;

  const LoginPhoneVerifyCodeScreen({
    super.key,
    required this.phoneNumber,
  });

  @override
  ConsumerState createState() => _LoginPhoneVerifyCodeScreenState();
}

class _LoginPhoneVerifyCodeScreenState
    extends ConsumerState<LoginPhoneVerifyCodeScreen> {
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          OtpTimerButton(
                            ...
                            text: Text(AppLocalizations.of(context)!.resend,
                              //"Resend",
                              style: TextStyle(
                                color: AppColors.whiteColor,
                                fontSize: 16,
                    ...
                    onTap: () async {
                      ...
                      if (_formKey.currentState?.validate() ?? false) {
                        ...
                        await authStateReadProvider
                            .verifyPhoneVerifyPasscodeLogin(
                              phoneNumber: widget.phoneNumber,
