...
class WithdrawPhoneVerifyCodeScreen extends ConsumerStatefulWidget {
  final String phoneNumber;
  final Map<String, dynamic> json;

  const WithdrawPhoneVerifyCodeScreen({
    super.key,
...
class _VerifyCodeScreenState
    extends ConsumerState<WithdrawPhoneVerifyCodeScreen> {
                  ...
                  getVerifyButton(
                    ...
                    onTap: () async {
                      ...
                      if (_formKey.currentState?.validate() ?? false) {
                        ...
                        await authStateReadProvider.withdrawPhoneVerifyPasscode(
                          phoneNumber: widget.phoneNumber,
                          json: widget.json,
