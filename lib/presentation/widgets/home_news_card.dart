    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          /// Title
          GetGenericText(
            text: newsUpdates.title ?? AppLocalizations.of(context)!.update_required,
          ...
          GestureDetector(
            onTap: () async {
              ...
              if (serviceUrl.isNotEmpty) {
                await CommonService.openServiceUrl(
                  serviceUrl: serviceUrl,
                );
              } else {
                Toasts.getWarningToast(text: AppLocalizations.of(context)!.link_not_available);
              }
            },
            child: Container(
              color: Colors.transparent,
